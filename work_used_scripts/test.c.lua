...
if ( t_iDrType == 1102        or t_iDrType == 1103     or t_iDrType == 1322 or t_iDrType == 1104
        or t_iDrType == 60101    or t_iDrType == 8002     or t_iDrType == 1312 or t_iDrType == 90515    --ISMG
        or t_iDrType == 90520                                                                           --add 个人彩云订购关系计费 20121116
        or t_iDrType == 5600    or t_iDrType == 5601     or t_iDrType == 80404or t_iDrType == 709    --gansu add
        or t_iDrType == 90416    or t_iDrType == 1126     or t_iDrType == 1122 or t_iDrType == 60002    --jiangx add
        or t_iDrType == 1124    or t_iDrType == 981102    or t_iDrType == 881102    --neimeng add
        or t_iDrType == 732004 ) then--xizang add
    t_sOutDrType        = "dr_ismg";
    t_sOutPostFix       = ".ismg";
    t_iServiceID        = 50006;
...
elseif (t_iDrType == 0        --HYWG
         or t_iDrType == 1222 or t_iDrType == 81701 or t_iDrType == 81702    --xizang add
         or t_iDrType == 880602) then--neimeng add
    t_sOutDrType        = "dr_ismg";
    t_sOutPostFix       = ".hywg";
    t_iServiceID        = 50006;
...
elseif (t_iDrType == 103 or t_iDrType == 90604        --MMS
         or t_iDrType == 787 or t_iDrType == 106        --gansu add
         or t_iDrType == 90605 or t_iDrType == 1402    --jiangx add
         or t_iDrType == 80601 or t_iDrType == 880601 ) then--neimeng add
    t_sOutDrType        = "dr_mms";
    t_sOutPostFix       = ".mms";
    t_iServiceID        = 50014;
    if (t_sRateProdID == "") then
        t_sRateProdID       = "50014001";
    end

    --RECORD_XDR_OUTPUT RECORD_XDR_OUTPUT   = 0
    --RECORD_XDR_OUTPUT RECORD_XDR_OUTPUT   = 0
    --RECORD_XDR_OUTPUT RECORD_XDR_OUTPUT   = 0
    --RECORD_XDR_OUTPUT RECORD_XDR_OUTPUT   = 0
    ...
    if (t_iBillFlag == 1) then
        t_iBillFlag         = 0;
    elseif (t_iBillFlag == 2) then
        t_iBillFlag         = 1;
    elseif (t_iBillFlag == 3) then
        t_iBillFlag         = 2;
    end
    PutXdrIntValue("CHARGE_TYPE",    t_iBillFlag    );
    PutXdrStrValue("MM_LENGTH",    t_sMessageLenth);
    PutXdrStrValue("RECEIVE_TIME",    t_sStopTime);
elseif ( t_iDrType == 104 or t_iDrType == 304 or t_iDrType == 105 or t_iDrType == 90508    --WAP
          or t_iDrType == 90502 or t_iDrType == 7104    --jiangx add
          or t_iDrType == 731 or t_iDrType == 90516 ) then
    t_sOutDrType        = "dr_wap";
    t_sOutPostFix       = ".wap";
    t_iServiceID        = 50007;
    if (t_sRateProdID == "") then
    ...
    if (t_iBillFlag == 1 or t_iBillFlag == 2) then
        t_iBillFlag         = 0;
    elseif (t_iBillFlag == 3) then
        t_iBillFlag         = 10;
    elseif (t_iBillFlag == 4) then
        t_iBillFlag         = 11;
    end
    PutXdrIntValue("RECORD_TYPE",    t_iBillFlag    );
    PutXdrStrValue("CDR_STATE",    t_sSendState    );
    PutXdrStrValue("GATEWAY_ID",    t_sIsmgId    );
elseif (t_iDrType == 5 or t_iDrType == 8007 or t_iDrType == 8003 or t_iDrType == 8011    --KJ
         or t_iDrType == 8001    --gansu add
         or t_iDrType == 60301    --jiangx add
         or t_iDrType == 729 ) then--neimeng add
    t_sOutDrType        = "dr_kj";
    t_sOutPostFix       = ".kj";
    t_iServiceID        = 50017;
    if (t_sRateProdID == "") then
    ...
    if (t_iForwardIsmgId == 1) then
        t_iForwardIsmgId    = 99;
    end
    PutXdrIntValue("DISCOUNT",    t_iForwardIsmgId);
elseif (t_iDrType == 1123) then--STM
    t_sOutDrType        = "dr_cbs";
    t_sOutPostFix       = ".stm";
    t_iServiceID        = 50050;
    --t_sRateProdID       = "50017001";
